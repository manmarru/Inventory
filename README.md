...
아이템 휠클릭: 아이템 정렬잠금/해제  
활성화된 버튼: 정렬, 펫 인벤토리  
<img width="161" height="42" alt="image" src="https://github.com/user-attachments/assets/02776f97-3a6c-4fa1-af40-53c471d2cde1" />


아이템을 좌클릭으로 끌어서 다른 아이템 슬롯에 놓거나 아이템간의 위치를 바꿀 수 있습니다.  
펫 인벤토리 버튼으로 아이템을 끌어다 놓으면 펫 인벤토리로 아이템이 옮겨집니다. 반대로 하는 것도 가능합니다.  
인벤토리 위쪽의 UI 프레임을 좌클릭으로 드래그해서 ui창을 움직일 수 있습니다.  
